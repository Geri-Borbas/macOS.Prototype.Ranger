...
public class LiveTourneyTable: Entry
{
    

    public let id_live_table: Int
    public let amt_ante: Double
    public let amt_sb: Double
    public let amt_bb: Double
    // amt_avg_stack
    // amt_min_stack
    // amt_pot
    // amt_rake
    public let cnt_players: Int
    // cnt_saw_flop
    // winner
    // cnt_hands
    // amt_pot_1
...
extension LiveTourneyTable: Equatable
{
    ...
    public static func == (lhs: LiveTourneyTable, rhs: LiveTourneyTable) -> Bool
    {
