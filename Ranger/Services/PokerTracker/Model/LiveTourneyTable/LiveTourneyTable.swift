...
extension PokerTracker.LiveTourneyTable: Equatable
{
    static func == (lhs: PokerTracker.LiveTourneyTable, rhs: PokerTracker.LiveTourneyTable) -> Bool
    {
...
extension PokerTracker.LiveTourneyTable: CustomStringConvertible
{
