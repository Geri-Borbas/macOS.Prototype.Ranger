...
extension PokerTracker.HandPlayer: Equatable
{
    static func == (lhs: PokerTracker.HandPlayer, rhs: PokerTracker.HandPlayer) -> Bool
    {
        return (
...
extension PokerTracker.HandPlayer: CustomStringConvertible
{
